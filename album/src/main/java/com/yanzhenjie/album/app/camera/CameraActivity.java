...
public class CameraActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mRealCamera = (Class) savedInstanceState.getSerializable(Album.KEY_INPUT_CAMERA_ACTIVITY);
            ...
            mRealCamera = (Class) bundle.getSerializable(Album.KEY_INPUT_CAMERA_ACTIVITY);
